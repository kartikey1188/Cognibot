...
def get_prompt_template():
    template = """
    You are an assistant helping with handbook queries. Answer the following question based on the provided context.
...
# API Resource for querying
class HandbookQuery(Resource):
    def post(self):
        try:
            # Parse request data
            ...
            chain = prompt | llm
            result = chain.invoke({"query": user_query, "context": context_text})
...
# Register resources
api.add_resource(HandbookQuery, '/api/handbook/query')
